...
$.overridePlugin('swProductSlider', {
    ...
    resetToStartPrev: function(){
        var me = this;
        me.scrollingReachedEndOfItems = false;
        me.setPosition((Math.floor(me.totalUniqueItems * me.itemSize)));
        $.publish('plugin/swProductSlider/onResetToStartPrev', [ me, me.currentPosition ]);
    },
    ...
    slidePrev: function () {
        ...
        if (me.totalUniqueItems && (me.currentPosition + me.itemSize) == me.itemSize) {
            me.opts.prevSlide = true;
        }
